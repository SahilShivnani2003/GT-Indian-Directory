...
import { Save, X, Shield, Bell, Lock, Eye } from "lucide-react";
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                type="email"
                defaultValue="rajesh@gtidirectory.com"
                className="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              defaultValue="I love exploring local businesses and trying new services."
              rows={4}
      ...
      {activeTab === "notifications" && (
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          {[
            ...
            {
              title: "SMS Alerts",
              description: "Get SMS alerts for order status",
              enabled: true,
            },
            {
              title: "Promotional Emails",
              description: "Receive deals and promotional content",
              enabled: false,
            },
            {
              title: "Business Recommendations",
              description: "Get personalized business suggestions",
              enabled: true,
            },
            {
              title: "Review Requests",
              description: "Be asked to review businesses you visited",
              enabled: true,
            },
          ].map((item, idx) => (
            <div
      ...
      {activeTab === "privacy" && (
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          {[
            ...
            {
              title: "Data Sharing",
              description: "Allow sharing of browsing data for improvements",
              enabled: false,
            },
          ].map((item, idx) => (
            <div
